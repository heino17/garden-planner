...
const PLANTS_DATA = [
  {
    id:"wermut", kind:"plant", shape:"circle", name:"Absinthe, armoise amère",
  ...
  {
    id:"schafgarbe", kind:"plant", shape:"circle", name:"Achillée millefeuille",
  ...
  {
    id:"knoblauch", kind:"plant", shape:"circle", name:"Ail",
  ...
  {
    id:"amaranth", kind:"plant", shape:"circle", name:"Amarante queue-de-renard",
    icon:"🌾", image:"images/amaranth.png", accent:"transparent", listAccent:"#b82d93",
  ...
  {
    id:"dill", kind:"plant", shape:"circle", name:"Aneth",
  ...
  {
    id:"engelwurz", kind:"plant", shape:"circle", name:"Angélique",
    icon:"🌿", accent:"#5c8f5c", plantSpacing:"?", latin:"Angelica archangelica, Doldenblütler",
    use:"Heilkraut", notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"anis", kind:"plant", shape:"circle", name:"Anis",
    icon:"🌿", image:"images/anis.png", accent:"transparent", listAccent:"#ca721f",
  ...
  {
    id:"erdnuss", kind:"plant", shape:"circle", name:"Arachide, cacahuète",
    icon:"🥜", accent:"#b08b2a", plantSpacing:"?", notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"beifuss", kind:"plant", shape:"circle", name:"Armoise commune",
  ...
  {
    id:"melde", kind:"plant", shape:"circle", name:"Arroche",
  ...
  {
    id:"artischocke", kind:"plant", shape:"circle", name:"Artichaut",
    icon:"🌿", image:"images/artischocke.png", accent:"transparent", listAccent:"#729f68",
    plantSpacing:"100", rowSpacing:"100", keimfaehigkeit:"4 – 6"
  },
  {
    id:"spargel", kind:"plant", shape:"circle", name:"Asperge",
  ...
  {
    id:"mangold_schnittmangold", kind:"plant", shape:"circle", name:"Bette à carde à couper",
    icon:"🥬", accent:"#8fa04a", plantSpacing:"20-30", rowSpacing:"30"
  },
  {
    id:"mangold", kind:"plant", shape:"circle", name:"Bette à carde, blette",
  ...
  {
    id:"rote_beete", kind:"plant", shape:"circle", name:"Betterave rouge",
  ...
  {
    id:"zuckerrube", kind:"plant", shape:"circle", name:"Betterave sucrière",
    icon:"🌱", accent:"#8b2a3f", plantSpacing:"20", rowSpacing:"30 - 50",
    keimfaehigkeit:"4"
  },
  {
    id:"kornblume", kind:"plant", shape:"circle", name:"Bleuet, centaurée",
  ...
  {
    id:"borretsch", kind:"plant", shape:"circle", name:"Bourrache",
  ...
  {
    id:"brokkoli", kind:"plant", shape:"circle", name:"Brocoli",
  ...
  {
    id:"ochsenzunge", kind:"plant", shape:"circle", name:"Buglosse",
  ...
  {
    id:"kamille", kind:"plant", shape:"circle", name:"Camomille",
  ...
  {
    id:"farberkamille", kind:"plant", shape:"circle", name:"Camomille des teinturiers",
    icon:"🌼", image:"images/faerberkamille.png", accent:"transparent", listAccent:"#dc8f21",
  ...
  {
    id:"kapuzinerkresse", kind:"plant", shape:"circle", name:"Capucine",
  ...
  {
    id:"bitterkresse", kind:"plant", shape:"circle", name:"Cardamine amère, cresson de terre",
    icon:"🥬", accent:"#8fa04a", plantSpacing:"10-20", rowSpacing:"20-30",
    latin:"Cochlearia officinalis, Kreuzblütler", use:"Salatkraut"
  },
  {
    id:"karotte", kind:"plant", shape:"circle", name:"Carotte",
  ...
  {
    id:"kummel", kind:"plant", shape:"circle", name:"Carvi",
  ...
  {
    id:"sellerie_stangensellerie_schnittsellerie", kind:"plant", shape:"circle", name:"Céleri : céleri branche",
  ...
  {
    id:"sellerie", kind:"plant", shape:"circle", name:"Céleri : céleri-rave",
  ...
  {
    id:"kerbel", kind:"plant", shape:"circle", name:"Cerfeuil",
  ...
  {
    id:"mariendistel", kind:"plant", shape:"circle", name:"Chardon-Marie",
    icon:"🌸", accent:"#9b6bb8", plantSpacing:"?", latin:"Silybum marianum, Distelgewächs",
    use:"Heilkraut", notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"chicoree", kind:"plant", shape:"circle", name:"Chicorée, endive",
    icon:"🥬", accent:"#8fa04a", plantSpacing:"25-30", rowSpacing:"30-35",
    sowDepth:"1-2"
  },
  {
    id:"weisskohl", kind:"plant", shape:"circle", name:"Chou blanc",
  ...
  {
    id:"chinakohl", kind:"plant", shape:"circle", name:"Chou chinois",
    icon:"🥬", accent:"#8fa04a", plantSpacing:"40", rowSpacing:"30",
    keimfaehigkeit:"4 – 6", topfgroesse:"geeignet für Topfkultur."
  },
  {
    id:"wirsingkohl", kind:"plant", shape:"circle", name:"Chou de Milan, chou frisé de Milan",
    icon:"🥬", accent:"#5c8f5c", plantSpacing:"40-60", rowSpacing:"45",
    sowDepth:"2", keimfaehigkeit:"2 – 4"
  },
  {
    id:"grunkohl", kind:"plant", shape:"circle", name:"Chou frisé, kale",
  ...
  {
    id:"kohlrabi", kind:"plant", shape:"circle", name:"Chou-rave",
  ...
  {
    id:"rosenkohl", kind:"plant", shape:"circle", name:"Choux de Bruxelles",
    icon:"🥬", accent:"#4c7a3d", plantSpacing:"40 (60-70)", rowSpacing:"60 (90)",
    sowDepth:"(1-) 2", standort:"kühleliebend, winterhart", keimfaehigkeit:"2 – 4", lebensdauer:"zweijährig, Insekten~"
  },
  {
    id:"schnittlauch", kind:"plant", shape:"circle", name:"Ciboulette",
  ...
  {
    id:"raps", kind:"plant", shape:"circle", name:"Colza",
  ...
  {
    id:"gurke", kind:"plant", shape:"circle", name:"Concombre : concombre de plein champ",
  ...
  {
    id:"koriander", kind:"plant", shape:"circle", name:"Coriandre",
  ...
  {
    id:"kurbis", kind:"plant", shape:"circle", name:"Courge, potiron",
    icon:"🎃", accent:"#d4772c", plantSpacing:"90-120", rowSpacing:"120",
    keimfaehigkeit:"4 – 6"
  },
  {
    id:"zucchini", kind:"plant", shape:"circle", name:"Courgette",
  ...
  {
    id:"kresse_gartenkresse", kind:"plant", shape:"circle", name:"Cresson : cresson alénois",
  ...
  {
    id:"kresse", kind:"plant", shape:"circle", name:"Cresson : cresson de fontaine",
    icon:"🥬", accent:"#4a8f5c", plantSpacing:"?", latin:"Nasturtium officinale, Kohlgewächs",
    notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"brunnenkresse", kind:"plant", shape:"circle", name:"Cresson de fontaine",
    icon:"🥬", accent:"#4a8f5c", plantSpacing:"10", rowSpacing:"30"
  },
  {
    id:"fruhlings_hungerblumchen", kind:"plant", shape:"circle", name:"Drave printanière",
  ...
  {
    id:"spinat", kind:"plant", shape:"circle", name:"Épinard",
  ...
  {
    id:"estragon", kind:"plant", shape:"circle", name:"Estragon russe",
  ...
  {
    id:"storchschnabel", kind:"plant", shape:"circle", name:"Géranium des bois",
  ...
  {
    id:"okra", kind:"plant", shape:"circle", name:"Gombo, okra",
  ...
  {
    id:"eibisch", kind:"plant", shape:"circle", name:"Guimauve officinale",
    icon:"🌸", accent:"#d68fb0", plantSpacing:"?", latin:"Althaea officinalis, Malvengewächs",
    use:"Heilkraut", notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"bohnen_dicke_bohne_ackerbohne", kind:"plant", shape:"circle", name:"Haricots : fève",
    icon:"🫘", accent:"#6b8c3f", plantSpacing:"15-20", rowSpacing:"40 (45)",
    sowDepth:"5", keimfaehigkeit:"2 – 4"
  },
  {
    id:"bohnen_feuerbohne", kind:"plant", shape:"circle", name:"Haricots : haricot d'Espagne",
    icon:"🫘", accent:"#c1442d", plantSpacing:"25-30", rowSpacing:"60-75",
    keimfaehigkeit:"2 – 4"
  },
  {
    id:"bohnen_limabohne", kind:"plant", shape:"circle", name:"Haricots : haricot de Lima",
    icon:"🫘", accent:"#6b8c3f", plantSpacing:"40-50", rowSpacing:"100-120",
    keimfaehigkeit:"2 – 4"
  },
  {
    id:"bohnen_buschbohne", kind:"plant", shape:"circle", name:"Haricots : haricot nain",
    icon:"🫘", accent:"#6b8c3f", plantSpacing:"20", rowSpacing:"45",
    sowDepth:"2", keimfaehigkeit:"2 – 4", lebensdauer:"einjährig, Selbst~"
  },
  {
    id:"bohnen_sojabohne", kind:"plant", shape:"circle", name:"Haricots : soja",
    icon:"🫘", accent:"#a0a83f", plantSpacing:"10-15", rowSpacing:"30-50",
    keimfaehigkeit:"2 – 4"
  },
  {
    id:"bohnen", kind:"plant", shape:"circle", name:"Haricots, haricot à rames",
  ...
  {
    id:"giersch", kind:"plant", shape:"circle", name:"Herbe aux goutteux, égopode",
  ...
  {
    id:"ysop", kind:"plant", shape:"circle", name:"Hysope",
  ...
  {
    id:"mais", kind:"plant", shape:"circle", name:"Maïs",
    icon:"🌽", accent:"#e0b32c", plantSpacing:"45", rowSpacing:"45",
    sowDepth:"4", keimfaehigkeit:"4 – 6"
  },
  {
    id:"majoran", kind:"plant", shape:"circle", name:"Marjolaine",
  ...
  {
    id:"malve", kind:"plant", shape:"circle", name:"Mauve sauvage",
    icon:"🌸", accent:"#a0629c", plantSpacing:"?", latin:"Malva sylvestris,",
    use:"Heilkraut", notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"zitronenmelisse", kind:"plant", shape:"circle", name:"Mélisse citronnelle",
  ...
  {
    id:"minze", kind:"plant", shape:"circle", name:"Menthe",
  ...
  {
    id:"pfefferminze", kind:"plant", shape:"circle", name:"Menthe poivrée",
  ...
  {
    id:"johanniskraut", kind:"plant", shape:"circle", name:"Millepertuis",
  ...
  {
    id:"brombeere", kind:"plant", shape:"circle", name:"Mûre, ronce",
    icon:"🫐", accent:"#3a2a5c", plantSpacing:"150", latin:"Rubus fruticosus,",
    use:"Beerenobst, Heilpflanze"
  },
  {
    id:"vergissmeinnicht", kind:"plant", shape:"circle", name:"Myosotis des champs",
  ...
  {
    id:"jungfer_im_grunen", kind:"plant", shape:"circle", name:"Nigelle de Damas",
  ...
  {
    id:"schwarzkummel", kind:"plant", shape:"circle", name:"Nigelle, cumin noir",
    icon:"🌸", accent:"#3f5fb0", plantSpacing:"?", latin:"Nigella sativa",
    notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"zwiebel", kind:"plant", shape:"circle", name:"Oignon",
  ...
  {
    id:"zwiebel_schalotten", kind:"plant", shape:"circle", name:"Oignon : échalote",
    icon:"🧅", accent:"#a0629c", plantSpacing:"15-20", rowSpacing:"20-30"
  },
  {
    id:"zwiebel_fruhlingszwiebel", kind:"plant", shape:"circle", name:"Oignon : oignon nouveau, ciboule",
    icon:"🧅", accent:"#6b8c3f", plantSpacing:"3 (25)", rowSpacing:"15 (30)",
    sowDepth:"1", keimfaehigkeit:"2 – 3"
  },
  {
    id:"zwiebel_lauch_porree", kind:"plant", shape:"circle", name:"Oignon : poireau",
  ...
  {
    id:"oregano", kind:"plant", shape:"circle", name:"Origan",
  ...
  {
    id:"tripmadam", kind:"plant", shape:"circle", name:"Orpin réfléchi, trique-madame",
    icon:"🌱", accent:"#9c8f3f", plantSpacing:"?", latin:"Sedum reflexum, Dickblattgewächs",
    use:"Salatkraut", notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"brennessel", kind:"plant", shape:"circle", name:"Ortie",
  ...
  {
    id:"petersilie", kind:"plant", shape:"circle", name:"Persil",
  ...
  {
    id:"petersilie_wurzelpetersilie", kind:"plant", shape:"circle", name:"Persil : persil à grosse racine",
    icon:"🌿", accent:"#3f6b3b", plantSpacing:"?", keimfaehigkeit:"2",
    notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"erbsen", kind:"plant", shape:"circle", name:"Petits pois",
  ...
  {
    id:"erbsen_zuckererbsen", kind:"plant", shape:"circle", name:"Petits pois : pois mange-tout",
    icon:"🟢", accent:"#5c9c4a", plantSpacing:"5-10", rowSpacing:"40 (60)",
    sowDepth:"5", keimfaehigkeit:"2 – 4", topfgroesse:"5 – 10 l (3 Pflanzen)"
  },
  {
    id:"chili", kind:"plant", shape:"circle", name:"Piment",
    icon:"🌶️", accent:"transparent", listAccent:"#eb1313", plantSpacing:"40-50",
    topfgroesse:"10 l"
  },
  {
    id:"peperoni", kind:"plant", shape:"circle", name:"Piment fort",
  ...
  {
    id:"pimpinelle", kind:"plant", shape:"circle", name:"Pimprenelle",
    icon:"🌿", accent:"#5c8f5c", plantSpacing:"?", latin:"Sanguisorba minor, Rosengewächs",
    use:"Salatkraut", notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"lowenzahn", kind:"plant", shape:"circle", name:"Pissenlit",
    icon:"🌼", accent:"#e0c94a", plantSpacing:"?", latin:"Taraxacum officinale, Korbblütler",
    use:"Salatkraut", notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"spitzwegerich", kind:"plant", shape:"circle", name:"Plantain lancéolé",
    icon:"🌿", accent:"#5c8f5c", plantSpacing:"?", latin:"Plantago lanceolata, Wegerichgewächs",
    use:"Wildkraut, Heilkraut", notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"paprika", kind:"plant", shape:"circle", name:"Poivron",
  ...
  {
    id:"kartoffel", kind:"plant", shape:"circle", name:"Pomme de terre",
  ...
  {
    id:"portulak", kind:"plant", shape:"circle", name:"Pourpier",
  ...
  {
    id:"winterpostelein", kind:"plant", shape:"circle", name:"Pourpier d'hiver, claytone de Cuba",
    icon:"🥬", accent:"#3f6b3b", plantSpacing:"?", latin:"Montia perfoliata, Portulakgewächs",
    use:"Salatkraut", notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"radieschen", kind:"plant", shape:"circle", name:"Radis",
    icon:"🫜", accent:"#c0392b", plantSpacing:"3-5", rowSpacing:"10-15",
    sowDepth:"1", keimfaehigkeit:"2 – 4", topfgroesse:"Blumenkasten"
  },
  {
    id:"rettich", kind:"plant", shape:"circle", name:"Radis noir",
    icon:"⚪", accent:"#d8d0c0", plantSpacing:"5-10", rowSpacing:"25",
    keimfaehigkeit:"2 – 4"
  },
  {
    id:"meerrettich", kind:"plant", shape:"circle", name:"Raifort",
  ...
  {
    id:"rhabarber", kind:"plant", shape:"circle", name:"Rhubarbe",
    icon:"🌱", accent:"#c0392b", plantSpacing:"?", standort:"wärmeliebend",
    notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"rosmarin", kind:"plant", shape:"circle", name:"Romarin",
  ...
  {
    id:"rucola", kind:"plant", shape:"circle", name:"Roquette : roquette cultivée",
  ...
  {
    id:"rucola_wilde_rauke", kind:"plant", shape:"circle", name:"Roquette : roquette sauvage",
  ...
  {
    id:"weinraute", kind:"plant", shape:"circle", name:"Rue officinale",
    icon:"🌿", accent:"#5c8f5c", plantSpacing:"30-40", latin:"Ruta graveolens, Korbblütler",
    use:"Küchenkraut"
  },
  {
    id:"steckrube", kind:"plant", shape:"circle", name:"Rutabaga, chou-navet",
    icon:"🥔", accent:"#d4c98f", plantSpacing:"8-10 (20-30)", rowSpacing:"20 (30)",
    sowDepth:"2", keimfaehigkeit:"4 – 6"
  },
  {
    id:"salat_endiviensalat", kind:"plant", shape:"circle", name:"Salade : chicorée frisée",
  ...
  {
    id:"salat_pflucksalat", kind:"plant", shape:"circle", name:"Salade : laitue à couper",
  ...
  {
    id:"salat", kind:"plant", shape:"circle", name:"Salade : laitue iceberg",
    icon:"🥬", accent:"#8fa04a", plantSpacing:"25-30", standort:"kühleliebend, winterhart",
    lebensdauer:"einjährig, Insekten~"
  },
  {
    id:"salat_kopfsalat", kind:"plant", shape:"circle", name:"Salade : laitue pommée",
  ...
  {
    id:"salat_feldsalat", kind:"plant", shape:"circle", name:"Salade : mâche",
  ...
  {
    id:"salat_radicchio", kind:"plant", shape:"circle", name:"Salade : trévise",
    icon:"🥬", accent:"#8b2a3f", plantSpacing:"30-40", rowSpacing:"30",
    keimfaehigkeit:"4 – 6"
  },
  {
    id:"buchweizen", kind:"plant", shape:"circle", name:"Sarrasin",
  ...
  {
    id:"bohnenkraut", kind:"plant", shape:"circle", name:"Sarriette d'été",
  ...
  {
    id:"bohnenkraut_winter", kind:"plant", shape:"circle", name:"Sarriette d'hiver",
  ...
  {
    id:"salbei", kind:"plant", shape:"circle", name:"Sauge",
  ...
  {
    id:"schwarzwurzel", kind:"plant", shape:"circle", name:"Scorsonère, salsifis noir",
    icon:"🌱", accent:"#3a2a1c", plantSpacing:"5-8 (10)", rowSpacing:"30",
    sowDepth:"1-2", keimfaehigkeit:"1 – 2"
  },
  {
    id:"ringelblume", kind:"plant", shape:"circle", name:"Souci, calendula",
  ...
  {
    id:"thymian", kind:"plant", shape:"circle", name:"Thym",
  ...
  {
    id:"linde", kind:"plant", shape:"circle", name:"Tilleul",
  ...
  {
    id:"topinambur", kind:"plant", shape:"circle", name:"Topinambour",
    icon:"🌻", accent:"#e0b32c", plantSpacing:"30-40", rowSpacing:"60-80"
  },
  {
    id:"sonnenblume", kind:"plant", shape:"circle", name:"Tournesol",
    icon:"🌻", image:"images/sonnenblume.webp", accent:"transparent", listAccent:"#fed447",
    plantSpacing:"?", keimfaehigkeit:"5", notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"klee", kind:"plant", shape:"circle", name:"Trèfle : trèfle pied-de-lièvre, trèfle des champs",
    icon:"☘️", accent:"#5c9c4a", plantSpacing:"?", latin:"Trifolium arvense, Hülsenfrüchtler",
    notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"huflattich", kind:"plant", shape:"circle", name:"Tussilage, pas-d'âne",
    icon:"🌼", accent:"#d4a72c", plantSpacing:"?", latin:"Tussilago farfara, Korbblütler",
    use:"Wildkraut, Heilkraut", notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"baldrian", kind:"plant", shape:"circle", name:"Valériane",
    icon:"🌸", accent:"#9b7bb8", plantSpacing:"90-100", latin:"Valeriana officinales, Baldriangewächs",
    use:"Heilkraut", keimung:"Lichtkeimer"
  },
  {
    id:"wicke", kind:"plant", shape:"circle", name:"Vesce de Hongrie",
  ...
  {
    id:"vogelwicke", kind:"plant", shape:"circle", name:"Vesce des oiseaux",
...
const MATERIALS_DATA = [
  {
    id:"geweg-stein", kind:"material", shape:"rect", name:"Allée en pierre",
  ...
  {
    id:"geweg-stein-rund", kind:"material", shape:"circle", name:"Allée en pierre ronde",
    icon:"🟪", image:"images/gehweg_grau.png", accent:"transparent", listAccent:"#7c7c7c",
    shape:"circle", diameterCm:30, pattern:"brickPattern"
  },
  {
    id:"fliegenpilz", kind:"material", shape:"circle", name:"Amanite tue-mouches",
  ...
  {
    id:"holzzaun_hoch", kind:"material", shape:"rect", name:"Clôture en bois, haute",
    icon:"🧱", accent:"#865e3c", shape:"rect", widthCm:4,
    heightCm:50
  },
  {
    id:"holzzaun_quer", kind:"material", shape:"rect", name:"Clôture en bois, horizontale",
    icon:"🧱", accent:"#865e3c", shape:"rect", widthCm:50,
    heightCm:4
  },
  {
    id:"brunnen_1", kind:"material", shape:"circle", name:"Fontaine",
    icon:"⛲", image:"images/brunnen.png", accent:"transparent", listAccent:"#99c1f1",
    shape:"circle", diameterCm:50
  },
  {
    id:"brunnen_gross", kind:"material", shape:"circle", name:"Grande fontaine",
    icon:"⛲", image:"images/brunnen.png", accent:"transparent", listAccent:"#99c1f1",
    shape:"circle", diameterCm:100, use:"Dekoration"
  },
  {
    id:"mauerziegel_hoch", kind:"material", shape:"rect", name:"Mur de briques, haut",
  ...
  {
    id:"mauerziegel_qeer", kind:"material", shape:"rect", name:"Mur de briques, horizontal",
  ...
  {
    id:"rasen_fläche", kind:"material", shape:"rect", name:"Pelouse",
    icon:"🍀", listAccent:"#4b8c05", shape:"rect", widthCm:50,
    heightCm:50, pattern:"grassPattern"
  },
  {
    id:"teich_klein", kind:"material", shape:"circle", name:"Petit étang rond",
    icon:"🟪", image:"images/teich_1.png", accent:"transparent", listAccent:"#99c1f1",
    shape:"circle", diameterCm:250
  },
  {
    id:"pool_klein", kind:"material", shape:"rect", name:"Petite piscine rectangulaire",
