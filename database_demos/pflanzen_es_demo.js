...
const PLANTS_DATA = [
  ...
  {
    id:"mangold_schnittmangold", kind:"plant", shape:"circle", name:"Acelga de corte",
    icon:"🥬", accent:"#8fa04a", plantSpacing:"20-30", rowSpacing:"30"
  },
  {
    id:"chicoree", kind:"plant", shape:"circle", name:"Achicoria, endibia",
    icon:"🥬", accent:"#8fa04a", plantSpacing:"25-30", rowSpacing:"30-35",
    sowDepth:"1-2"
  },
  {
    id:"kornblume", kind:"plant", shape:"circle", name:"Aciano, azulejo",
  ...
  {
    id:"bohnenkraut_winter", kind:"plant", shape:"circle", name:"Ajedrea de invierno",
  ...
  {
    id:"bohnenkraut", kind:"plant", shape:"circle", name:"Ajedrea de verano",
  ...
  {
    id:"wermut", kind:"plant", shape:"circle", name:"Ajenjo",
  ...
  {
    id:"jungfer_im_grunen", kind:"plant", shape:"circle", name:"Ajenuz, comino negro decorativo",
  ...
  {
    id:"knoblauch", kind:"plant", shape:"circle", name:"Ajo",
  ...
  {
    id:"barlauch", kind:"plant", shape:"circle", name:"Ajo silvestre, ajo de oso",
    icon:"🌿", accent:"#3f6b3b", plantSpacing:"15-20", latin:"Allium ursinum, Zwiebelgewächs",
    use:"Wildkraut", notiz:"Bis 25 Pflanzen pro m²"
  },
  {
    id:"basilikum", kind:"plant", shape:"circle", name:"Albahaca",
  ...
  {
    id:"artischocke", kind:"plant", shape:"circle", name:"Alcachofa",
    icon:"🌿", image:"images/artischocke.png", accent:"transparent", listAccent:"#87bf29",
    plantSpacing:"100", rowSpacing:"100", keimfaehigkeit:"4 – 6"
  },
  {
    id:"kummel", kind:"plant", shape:"circle", name:"Alcaravea",
  ...
  {
    id:"buchweizen", kind:"plant", shape:"circle", name:"Alforfón, trigo sarraceno",
  ...
  {
    id:"frauenmantel", kind:"plant", shape:"circle", name:"Alquimila, pie de león",
  ...
  {
    id:"klatschmohn", kind:"plant", shape:"circle", name:"Amapola",
  ...
  {
    id:"amaranth", kind:"plant", shape:"circle", name:"Amaranto colgante, bledo",
  ...
  {
    id:"engelwurz", kind:"plant", shape:"circle", name:"Angélica",
    icon:"🌿", accent:"#5c8f5c", plantSpacing:"?", latin:"Angelica archangelica, Doldenblütler",
    use:"Heilkraut", notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"anis", kind:"plant", shape:"circle", name:"Anís",
    icon:"🌿", image:"images/anis.png", accent:"transparent", listAccent:"#dc8f21",
  ...
  {
    id:"sellerie_stangensellerie_schnittsellerie", kind:"plant", shape:"circle", name:"Apio: apio de tallo",
  ...
  {
    id:"sellerie", kind:"plant", shape:"circle", name:"Apio: apio nabo",
  ...
  {
    id:"melde", kind:"plant", shape:"circle", name:"Armuelle",
  ...
  {
    id:"beifuss", kind:"plant", shape:"circle", name:"Artemisa",
  ...
  {
    id:"vogelwicke", kind:"plant", shape:"circle", name:"Arveja, veza de pájaro",
  ...
  {
    id:"klette", kind:"plant", shape:"circle", name:"Bardana",
  ...
  {
    id:"aubergine", kind:"plant", shape:"circle", name:"Berenjena",
    icon:"🍆", accent:"#5b3a86", plantSpacing:"45", rowSpacing:"(45) 60",
    sowDepth:"1", keimfaehigkeit:"4 – 6", topfgroesse:"10 l"
  },
  {
    id:"goldmelisse", kind:"plant", shape:"circle", name:"Bergamota silvestre, monarda",
    icon:"🌺", accent:"#c0392b", plantSpacing:"?", latin:"Monarda didyma, Lippenblütler",
    use:"Heilkraut", notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"brunnenkresse", kind:"plant", shape:"circle", name:"Berro de agua",
    icon:"🥬", accent:"#4a8f5c", plantSpacing:"10", rowSpacing:"30"
  },
  {
    id:"bitterkresse", kind:"plant", shape:"circle", name:"Berro de tierra, mastuerzo de campo",
    icon:"🥬", accent:"#8fa04a", plantSpacing:"10-20", rowSpacing:"20-30",
    latin:"Cochlearia officinalis, Kreuzblütler", use:"Salatkraut"
  },
  {
    id:"kresse", kind:"plant", shape:"circle", name:"Berro: berro de agua",
    icon:"🥬", accent:"#4a8f5c", plantSpacing:"?", latin:"Nasturtium officinale, Kohlgewächs",
    notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"kresse_gartenkresse", kind:"plant", shape:"circle", name:"Berro: mastuerzo de jardín",
  ...
  {
    id:"lowenmaul", kind:"plant", shape:"circle", name:"Boca de dragón, dragoncillo",
  ...
  {
    id:"borretsch", kind:"plant", shape:"circle", name:"Borraja",
  ...
  {
    id:"brokkoli", kind:"plant", shape:"circle", name:"Brócoli",
  ...
  {
    id:"ochsenzunge", kind:"plant", shape:"circle", name:"Buglosa",
  ...
  {
    id:"kurbis", kind:"plant", shape:"circle", name:"Calabaza",
    icon:"🎃", accent:"#d4772c", plantSpacing:"90-120", rowSpacing:"120",
    keimfaehigkeit:"4 – 6"
  },
  {
    id:"ringelblume", kind:"plant", shape:"circle", name:"Caléndula",
  ...
  {
    id:"kapuzinerkresse", kind:"plant", shape:"circle", name:"Capuchina",
  ...
  {
    id:"mariendistel", kind:"plant", shape:"circle", name:"Cardo mariano",
    icon:"🌸", accent:"#9b6bb8", plantSpacing:"?", latin:"Silybum marianum, Distelgewächs",
    use:"Heilkraut", notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"zwiebel", kind:"plant", shape:"circle", name:"Cebolla",
  ...
  {
    id:"zwiebel_fruhlingszwiebel", kind:"plant", shape:"circle", name:"Cebolla: cebolleta",
    icon:"🧅", accent:"#6b8c3f", plantSpacing:"3 (25)", rowSpacing:"15 (30)",
    sowDepth:"1", keimfaehigkeit:"2 – 3"
  },
  {
    id:"zwiebel_schalotten", kind:"plant", shape:"circle", name:"Cebolla: chalota",
    icon:"🧅", accent:"#a0629c", plantSpacing:"15-20", rowSpacing:"20-30"
  },
  {
    id:"zwiebel_lauch_porree", kind:"plant", shape:"circle", name:"Cebolla: puerro",
  ...
  {
    id:"schnittlauch", kind:"plant", shape:"circle", name:"Cebollino",
  ...
  {
    id:"meerkohl", kind:"plant", shape:"circle", name:"Col marina",
    icon:"🥬", accent:"#8fa04a", plantSpacing:"?", notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"grunkohl", kind:"plant", shape:"circle", name:"Col rizada, kale",
  ...
  {
    id:"rosenkohl", kind:"plant", shape:"circle", name:"Coles de Bruselas",
  ...
  {
    id:"blumenkohl", kind:"plant", shape:"circle", name:"Coliflor",
  ...
  {
    id:"steckrube", kind:"plant", shape:"circle", name:"Colinabo",
    icon:"🥔", accent:"#d4c98f", plantSpacing:"8-10 (20-30)", rowSpacing:"20 (30)",
    sowDepth:"2", keimfaehigkeit:"4 – 6"
  },
  {
    id:"kohlrabi", kind:"plant", shape:"circle", name:"Colirrábano",
  ...
  {
    id:"schwarzkummel", kind:"plant", shape:"circle", name:"Comino negro, neguilla",
    icon:"🌸", accent:"#3f5fb0", plantSpacing:"?", latin:"Nigella sativa",
    notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"beinwell", kind:"plant", shape:"circle", name:"Consuelda",
    icon:"🌿", accent:"#4a6b3f", plantSpacing:"45", latin:"Symphytum officinale, Rauhblattgewächs",
    use:"Wildkraut, Heilkraut", notiz:"4-6 pro m²"
  },
  {
    id:"lowenzahn", kind:"plant", shape:"circle", name:"Diente de león",
    icon:"🌼", accent:"#e0c94a", plantSpacing:"?", latin:"Taraxacum officinale, Korbblütler",
    use:"Salatkraut", notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"fruhlings_hungerblumchen", kind:"plant", shape:"circle", name:"Draba de primavera",
  ...
  {
    id:"dill", kind:"plant", shape:"circle", name:"Eneldo",
  ...
  {
    id:"schwarzwurzel", kind:"plant", shape:"circle", name:"Escorzonera",
    icon:"🌱", accent:"#3a2a1c", plantSpacing:"5-8 (10)", rowSpacing:"30",
    sowDepth:"1-2", keimfaehigkeit:"1 – 2"
  },
  {
    id:"spargel", kind:"plant", shape:"circle", name:"Espárrago",
    icon:"🌱", accent:"#7a9c4a", plantSpacing:"?", standort:"wärmeliebend, winterhart",
    notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"spinat", kind:"plant", shape:"circle", name:"Espinaca",
  ...
  {
    id:"estragon", kind:"plant", shape:"circle", name:"Estragón ruso",
  ...
  {
    id:"erdbeere", kind:"plant", shape:"circle", name:"Fresa",
    icon:"🍓", accent:"transparent", listAccent:"#ff2020", plantSpacing:"25-30",
    rowSpacing:"60", lebensdauer:"mehrjährig"
  },
  {
    id:"walderdbeere", kind:"plant", shape:"circle", name:"Fresa silvestre",
  ...
  {
    id:"storchschnabel", kind:"plant", shape:"circle", name:"Geranio silvestre, hierba de San Roberto",
  ...
  {
    id:"sonnenblume", kind:"plant", shape:"circle", name:"Girasol",
    icon:"🌻", image:"images/sonnenblume.webp", accent:"transparent", listAccent:"#f6d32d",
    plantSpacing:"?", keimfaehigkeit:"5", notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"peperoni", kind:"plant", shape:"circle", name:"Guindilla picante",
  ...
  {
    id:"erbsen", kind:"plant", shape:"circle", name:"Guisantes",
  ...
  {
    id:"erbsen_zuckererbsen", kind:"plant", shape:"circle", name:"Guisantes: tirabeque",
    icon:"🟢", accent:"#5c9c4a", plantSpacing:"5-10", rowSpacing:"40 (60)",
    sowDepth:"5", keimfaehigkeit:"2 – 4", topfgroesse:"5 – 10 l (3 Pflanzen)"
  },
  {
    id:"giersch", kind:"plant", shape:"circle", name:"Hierba de San Gerardo, podagraria",
  ...
  {
    id:"alant", kind:"plant", shape:"circle", name:"Ínula, helenio",
    icon:"🌼", accent:"#c9a13b", plantSpacing:"60", latin:"Inula helenium, Korbblütler",
    use:"Heilkraut"
  },
  {
    id:"bohnen", kind:"plant", shape:"circle", name:"Judías, judía de enrame",
  ...
  {
    id:"salat_feldsalat", kind:"plant", shape:"circle", name:"Lechuga: canónigos, hierba de los canónigos",
  ...
  {
    id:"salat_endiviensalat", kind:"plant", shape:"circle", name:"Lechuga: escarola",
  ...
  {
    id:"salat_kopfsalat", kind:"plant", shape:"circle", name:"Lechuga: lechuga de cabeza",
  ...
  {
    id:"salat_pflucksalat", kind:"plant", shape:"circle", name:"Lechuga: lechuga de hoja suelta",
  ...
  {
    id:"farberkamille", kind:"plant", shape:"circle", name:"Manzanilla de tintes",
  ...
  {
    id:"ganseblumchen", kind:"plant", shape:"circle", name:"Margarita",
    icon:"🌼", accent:"#e0c94a", plantSpacing:"?", latin:"Bellis perennis, Korbblütler",
    use:"Wildkraut", notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"majoran", kind:"plant", shape:"circle", name:"Mejorana",
  ...
  {
    id:"zitronenmelisse", kind:"plant", shape:"circle", name:"Melisa, toronjil",
  ...
  {
    id:"melone", kind:"plant", shape:"circle", name:"Melón",
  ...
  {
    id:"minze", kind:"plant", shape:"circle", name:"Menta",
  ...
  {
    id:"pfefferminze", kind:"plant", shape:"circle", name:"Menta piperita",
  ...
  {
    id:"hirse", kind:"plant", shape:"circle", name:"Mijo",
  ...
  {
    id:"okra", kind:"plant", shape:"circle", name:"Okra, quingombó",
  ...
  {
    id:"oregano", kind:"plant", shape:"circle", name:"Orégano",
  ...
  {
    id:"brennessel", kind:"plant", shape:"circle", name:"Ortiga",
  ...
  {
    id:"topinambur", kind:"plant", shape:"circle", name:"Pataca, alcachofa de Jerusalén",
    icon:"🌻", accent:"#e0b32c", plantSpacing:"30-40", rowSpacing:"60-80"
  },
  {
    id:"kartoffel", kind:"plant", shape:"circle", name:"Patata",
  ...
  {
    id:"stiefmutterchen", kind:"plant", shape:"circle", name:"Pensamiento silvestre",
  ...
  {
    id:"gurke", kind:"plant", shape:"circle", name:"Pepino: pepino de exterior",
  ...
  {
    id:"petersilie", kind:"plant", shape:"circle", name:"Perejil",
  ...
  {
    id:"petersilie_wurzelpetersilie", kind:"plant", shape:"circle", name:"Perejil: perejil de raíz",
    icon:"🌿", accent:"#3f6b3b", plantSpacing:"?", keimfaehigkeit:"2",
    notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"kerbel", kind:"plant", shape:"circle", name:"Perifollo",
  ...
  {
    id:"paprika", kind:"plant", shape:"circle", name:"Pimiento",
  ...
  {
    id:"rote_beete", kind:"plant", shape:"circle", name:"Remolacha",
  ...
  {
    id:"zuckerrube", kind:"plant", shape:"circle", name:"Remolacha azucarera",
    icon:"🌱", accent:"#8b2a3f", plantSpacing:"20", rowSpacing:"30 - 50",
    keimfaehigkeit:"4"
  },
  {
    id:"weisskohl", kind:"plant", shape:"circle", name:"Repollo blanco",
    icon:"🥬", accent:"#8fa04a", plantSpacing:"50", rowSpacing:"60",
    sowDepth:"2", standort:"kühleliebend, winterhart", aussaat:"10 Wochen vor dem letzten Frost", keimung:"5 – 8",
    keimfaehigkeit:"2 – 4", lebensdauer:"zweijährig, Insekten~"
  },
  {
    id:"spitzkohl", kind:"plant", shape:"circle", name:"Repollo puntiagudo",
    icon:"🥬", accent:"#8fa04a", plantSpacing:"40-50", keimfaehigkeit:"2 – 4"
  },
  {
    id:"rosmarin", kind:"plant", shape:"circle", name:"Romero",
  ...
  {
    id:"rucola", kind:"plant", shape:"circle", name:"Rúcula: rúcula cultivada",
  ...
  {
    id:"rucola_wilde_rauke", kind:"plant", shape:"circle", name:"Rúcula: rúcula silvestre",
  ...
  {
    id:"weinraute", kind:"plant", shape:"circle", name:"Ruda",
    icon:"🌿", accent:"#5c8f5c", plantSpacing:"30-40", latin:"Ruta graveolens, Korbblütler",
    use:"Küchenkraut"
  },
  {
    id:"rhabarber", kind:"plant", shape:"circle", name:"Ruibarbo",
    icon:"🌱", accent:"#c0392b", plantSpacing:"?", standort:"wärmeliebend",
    notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"salbei", kind:"plant", shape:"circle", name:"Salvia",
  ...
  {
    id:"linde", kind:"plant", shape:"circle", name:"Tilo",
  ...
  {
    id:"thymian", kind:"plant", shape:"circle", name:"Tomillo",
  ...
  {
    id:"winterpostelein", kind:"plant", shape:"circle", name:"Verdolaga de invierno, valerianela de Cuba",
    icon:"🥬", accent:"#3f6b3b", plantSpacing:"?", latin:"Montia perfoliata, Portulakgewächs",
    use:"Salatkraut", notiz:"[Pflanzabstand nicht in CSV enthalten - noch zu recherchieren/ergaenzen]"
  },
  {
    id:"wicke", kind:"plant", shape:"circle", name:"Veza húngara",
  ...
  {
    id:"karotte", kind:"plant", shape:"circle", name:"Zanahoria",
  ...
  {
    id:"brombeere", kind:"plant", shape:"circle", name:"Zarzamora",
...
const MATERIALS_DATA = [
  ...
  {
    id:"geweg-stein-rund", kind:"material", shape:"circle", name:"Camino de piedra redondo",
    icon:"🟪", image:"images/gehweg_grau.png", accent:"#046312", shape:"circle",
    diameterCm:30, pattern:"brickPattern"
  },
  {
    id:"teich_klein", kind:"material", shape:"circle", name:"Estanque pequeño redondo",
    icon:"🟪", image:"images/teich_1.png", accent:"#5ab8e2", shape:"circle",
    diameterCm:250
  },
  {
    id:"brunnen_1", kind:"material", shape:"circle", name:"Fuente",
    icon:"⛲", image:"images/brunnen.png", accent:"transparent", listAccent:"#99c1f1",
    shape:"circle", diameterCm:100
  },
  {
    id:"brunnen_klein", kind:"material", shape:"circle", name:"Fuente pequeña",
    icon:"⛲", image:"images/brunnen.png", accent:"transparent", listAccent:"#99c1f1",
    shape:"circle", diameterCm:50, use:"Dekoration"
  },
  {
    id:"mauerziegel_hoch", kind:"material", shape:"rect", name:"Muro de ladrillo, alto",
  ...
  {
    id:"mauerziegel_qeer", kind:"material", shape:"rect", name:"Muro de ladrillo, horizontal",
  ...
  {
    id:"pool_klein", kind:"material", shape:"rect", name:"Piscina pequeña rectangular",
    image:"images/teich_1.png", accent:"#5ab8e2", shape:"rect", widthCm:250,
    heightCm:400
  },
  {
    id:"holzzaun_hoch", kind:"material", shape:"rect", name:"Valla de madera, alta",
    icon:"🧱", accent:"#865e3c", shape:"rect", widthCm:4,
    heightCm:50
  },
  {
    id:"holzzaun_quer", kind:"material", shape:"rect", name:"Valla de madera, horizontal",
    icon:"🧱", accent:"#865e3c", shape:"rect", widthCm:50,
    heightCm:4
  },
  {
    id:"rasen_fläche", kind:"material", shape:"rect", name:"Zona de césped",
    icon:"🍀", listAccent:"#21b112", shape:"rect", widthCm:50,
